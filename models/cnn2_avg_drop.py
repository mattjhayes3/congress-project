...
class CNN2AvgDropModel(SequenceModel):
    ...
    def name(self):
        ...
        return f'cnn2_a10-4_avg_drop_128_7_l{self.lsize}_s1_d3_{dint}_e{self.embedding_size}{glove_part}' if not self.instance_name else f"cnn2_a10-4_avg_drop_128_7_l{self.lsize}_s1_d3_{dint}_e{self.embedding_size}{glove_part}_{self.instance_name}"
