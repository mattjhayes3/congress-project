...
class Transformer2Model(SequenceModel):
    ...
    def name(self):
        ...
        return f'transformer2_e{self.embedding_size}_2_d3_10_l{self.t_size}{glove_part}' if not self.instance_name else f"transformer2_e{self.embedding_size}_2_d3_10_l{self.t_size}{glove_part}_{self.instance_name}"
